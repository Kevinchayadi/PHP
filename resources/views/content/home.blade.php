...
@section('meta-description', 'Selamat datang di PT. Parung Hijau Perkasa. Temukan solusi inovatif kami untuk peternakan unggul dan pengelolaan limbah yang berkelanjutan.')
@section('meta-keywords', 'PT. Parung Hijau Perkasa,Parung Hijau Perkasa, Parung Hijau, parung hijau perkasa, peternakan, pengelolaan limbah, Bogor, Sungrow, Adiluhung, pisang Cavendish, ayam berkualitas, ikan patin, manajemen limbah')

@section('og-title', 'Beranda - PT. Parung Hijau Perkasa')
@section('og-description', 'Selamat datang di PT. Parung Hijau Perkasa. Temukan solusi inovatif kami untuk peternakan unggul dan pengelolaan limbah yang berkelanjutan.')
@section('og-url', url('https://parunghijauperkasa.com/home'))

@section('twitter-title', 'Beranda - PT. Parung Hijau Perkasa')
@section('twitter-description', 'Selamat datang di PT. Parung Hijau Perkasa. Temukan solusi inovatif kami untuk peternakan unggul dan pengelolaan limbah yang berkelanjutan.')
@section('twitter-url', url('https://parunghijauperkasa.com/home'))
    ...
    <section id="whoweare" class="whoweare" data-aos="fade-up">
        <div class="container my-5 p-5 text-center border-bottom">
            <div class="col">
                ...
                <a href="/about-us" class="btn-cust">cari tahu lebih lanjut</a>
            </div>
        </div>
    </section>
                ...
                <div class="row mx-2 mb-5 ">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-xs-12 my-3 d-flex justify-content-center card-product">
                        <div class="card card-style h-100" style="width: 18rem;">
                            <img src="{{ asset("../Img/pisang1.jpg") }}" class="card-img-top" alt="Kebun-Sungrow">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-xs-12 my-3 d-flex justify-content-center card-product">
                        <div class="card card-style h-100" style="width: 18rem;">
                            <img src="{{ asset("../Img/ayam1.jpg") }}" class="card-img-top" alt="Kandang-Adiluhur">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-xs-12 my-3 d-flex justify-content-center card-product">
                        <div class="card card-style h-100" style="width: 18rem;">
                            <img src="{{ asset("../Img/ikan.png") }}" class="card-img-top" alt="Kolam-ikan-Adiluhur">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-xs-12 my-3 d-flex justify-content-center card-product">
                        <div class="card card-style h-100" style="width: 18rem;">
                            <img src="{{ asset("../Img/waste1.png") }}" class="card-img-top" alt="Budidaya-Magot">
                            <div class="card-body">
